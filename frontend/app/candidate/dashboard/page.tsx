      ...
      <div className="relative bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-700 rounded-3xl px-8 py-10 mb-10 overflow-hidden">
        ...
        <div className="relative flex items-center justify-between gap-6">
          ...
          <button
            ...
            className="flex-shrink-0 inline-flex items-center gap-2 px-6 py-3.5 bg-white text-indigo-700 text-base font-bold rounded-2xl hover:bg-indigo-50 transition-colors shadow-lg"
          >
